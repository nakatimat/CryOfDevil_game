...
namespace UnityEngine.PostProcessing
{
    public sealed class TaaComponent : PostProcessingComponentRenderTexture<AntialiasingModel>
    {
        static class Uniforms
        {
            ...
            internal static int _FinalBlendParameters = Shader.PropertyToID(
        ...
        public void Render(RenderTexture source, RenderTexture destination)
        {
            ...
            if (
                ...
                || m_HistoryTexture.width != source.width
            ...
            )
            {
                ...
                m_HistoryTexture = RenderTexture.GetTemporary(
                    source.width,
                    source.height,
                    0,
                    source.format
            ...
            material.SetVector(
                Uniforms._SharpenParameters,
                new Vector4(settings.sharpen, 0f, 0f, 0f)
            );
            material.SetVector(
                Uniforms._FinalBlendParameters,
                new Vector4(
            ...
            var tempHistory = RenderTexture.GetTemporary(
                source.width,
                source.height,
                0,
                source.format
        ...
        Matrix4x4 GetPerspectiveProjectionMatrix(Vector2 offset)
        {
            ...
            matrix[2, 2] =
                ...
                / (context.camera.farClipPlane - context.camera.nearClipPlane);
            matrix[2, 3] =
                -(2f * context.camera.farClipPlane * context.camera.nearClipPlane)
                / (context.camera.farClipPlane - context.camera.nearClipPlane);
