namespace UnityEngine.PostProcessing
{
    public sealed class BloomComponent : PostProcessingComponentRenderTexture<BloomModel>
    {
        static class Uniforms
        {
            ...
            internal static readonly int _Bloom_DirtIntensity = Shader.PropertyToID(
        ...
        public override bool active
        {
            get
            {
                return model.enabled && model.settings.bloom.intensity > 0f && !context.interrupted;
            }
        }
        ...
        public void Prepare(RenderTexture source, Material uberMaterial, Texture autoExposure)
        {
            ...
            uberMaterial.SetVector(
                Uniforms._Bloom_Settings,
                new Vector2(sampleScale, bloom.intensity)
            );
