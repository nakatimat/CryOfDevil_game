namespace UnityEngine.PostProcessing
{
        ...
        : PostProcessingComponentRenderTexture<ChromaticAberrationModel>
    {
        ...
        {
            internal static readonly int _ChromaticAberration_Amount = Shader.PropertyToID(
                "_ChromaticAberration_Amount"
            );
            internal static readonly int _ChromaticAberration_Spectrum = Shader.PropertyToID(
