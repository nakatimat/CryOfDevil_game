...
namespace UnityEngine.PostProcessing
{
    ...
    public sealed class DepthOfFieldComponent
        : PostProcessingComponentRenderTexture<DepthOfFieldModel>
    {
        static class Uniforms
        {
            internal static readonly int _DepthOfFieldTex = Shader.PropertyToID("_DepthOfFieldTex");
            internal static readonly int _DepthOfFieldCoCTex = Shader.PropertyToID(
                "_DepthOfFieldCoCTex"
            );
            ...
            internal static readonly int _DepthOfFieldParams = Shader.PropertyToID(
                "_DepthOfFieldParams"
            );
        }
        ...
        {
            return m_CoCHistory != null
                && m_CoCHistory.IsCreated()
                && m_CoCHistory.width == width
                && m_CoCHistory.height == height;
        }
        ...
        )
        {
            ...
            var rtCoC = context.renderTextureFactory.Get(
                context.width,
                context.height,
                0,
                cocFormat,
            ...
            if (antialiasCoC)
            {
                ...
                material.SetVector(
                    Uniforms._TaaParams,
                    new Vector3(taaJitter.x, taaJitter.y, blend)
                );

                var rtFiltered = RenderTexture.GetTemporary(
                    context.width,
                    context.height,
                    0,
                    cocFormat
            ...
            var rt1 = context.renderTextureFactory.Get(
                context.width / 2,
                context.height / 2,
                0,
                colorFormat
            ...
            var rt2 = context.renderTextureFactory.Get(
                context.width / 2,
                context.height / 2,
                0,
                colorFormat
