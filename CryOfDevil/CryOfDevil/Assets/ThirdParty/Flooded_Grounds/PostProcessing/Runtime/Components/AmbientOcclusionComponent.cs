...
namespace UnityEngine.PostProcessing
{
        ...
        : PostProcessingComponentCommandBuffer<AmbientOcclusionModel>
    {
        static class Uniforms
        {
            ...
            internal static readonly int _OcclusionTexture1 = Shader.PropertyToID(
                "_OcclusionTexture1"
            );
            internal static readonly int _OcclusionTexture2 = Shader.PropertyToID(
                "_OcclusionTexture2"
            );
            internal static readonly int _OcclusionTexture = Shader.PropertyToID(
                "_OcclusionTexture"
            );
        ...
        bool ambientOnlySupported
        {
            get
            {
                return context.isHdr
                    && model.settings.ambientOnly
        ...
        {
            get { return model.enabled && model.settings.intensity > 0f && !context.interrupted; }
        }
        ...
        public override CameraEvent GetCameraEvent()
        {
            return
                ...
                && !context.profile.debugViews.IsModeActive(DebugMode.AmbientOcclusion)
