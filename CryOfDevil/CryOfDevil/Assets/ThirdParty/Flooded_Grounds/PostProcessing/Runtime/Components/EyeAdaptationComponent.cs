namespace UnityEngine.PostProcessing
{
        ...
        : PostProcessingComponentRenderTexture<EyeAdaptationModel>
    {
        static class Uniforms
        {
            ...
            internal static readonly int _ExposureCompensation = Shader.PropertyToID(
        ...
        public override bool active
        {
            get
            {
                return model.enabled && SystemInfo.supportsComputeShaders && !context.interrupted;
            }
        }
        ...
        Vector4 GetHistogramScaleOffsetRes()
        {
            ...
            return new Vector4(
                scale,
                offset,
                Mathf.Floor(context.width / 2f),
                Mathf.Floor(context.height / 2f)
            );
        }
        ...
        public Texture Prepare(RenderTexture source, Material uberMaterial)
        {
            ...
            var rt = context.renderTextureFactory.Get(
            ...
            m_EyeCompute.Dispatch(
                kernel,
                Mathf.CeilToInt(rt.width / (float)k_HistogramThreadX),
                Mathf.CeilToInt(rt.height / (float)k_HistogramThreadY),
                1
            );
            ...
            settings.lowPercent = Mathf.Clamp(
                settings.lowPercent,
                1f,
                settings.highPercent - minDelta
            );
            ...
            material.SetVector(
                Uniforms._Params,
                new Vector4(
                    settings.lowPercent * 0.01f,
                    settings.highPercent * 0.01f,
            ...
            if (m_FirstFrame || !Application.isPlaying)
            {
                ...
                Graphics.Blit(
                    ...
                    material,
                    (int)EyeAdaptationModel.EyeAdaptationType.Fixed
                );
