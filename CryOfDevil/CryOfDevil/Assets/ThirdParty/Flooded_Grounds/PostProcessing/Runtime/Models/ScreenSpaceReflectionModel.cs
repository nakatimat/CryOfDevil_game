...
namespace UnityEngine.PostProcessing
{
    ...
    public class ScreenSpaceReflectionModel : PostProcessingModel
    {
        ...
        public struct ReflectionSettings
        {
            ...
            [Tooltip(
                "Disable for a performance gain in scenes where most glossy objects are horizontal, like floors, water, and tables. Leave on for scenes with glossy vertical objects."
            )]
            ...
            public static Settings defaultSettings
            {
                get
                {
                    return new Settings
                    {
                        ...
                        screenEdgeMask = new ScreenEdgeMask { intensity = 0.03f },
                    };
                }
            }
        }
