...
namespace UnityEngine.PostProcessing
{
    ...
    public class AntialiasingModel : PostProcessingModel
    {
        ...
        {
            [Tooltip(
                "The amount of desired sub-pixel aliasing removal. Effects the sharpeness of the output."
            )]
            [Range(0f, 1f)]
            public float subpixelAliasingRemovalAmount;

            [Tooltip(
                "The minimum amount of local contrast required to qualify a region as containing an edge."
            )]
            [Range(0.063f, 0.333f)]
            public float edgeDetectionThreshold;

            [Tooltip(
                "Local contrast adaptation value to disallow the algorithm from executing on the darker regions."
            )]
            [Range(0f, 0.0833f)]
        ...
        public struct FxaaSettings
        {
            ...
            {
                get { return new FxaaSettings { preset = FxaaPreset.Default }; }
            }
        }
        #endregion
