...
namespace UnityEngine.PostProcessing
{
    ...
    public class PostProcessingBehaviour : MonoBehaviour
    {
        ...
        List<PostProcessingComponentBase> m_ComponentsToEnable =
            new List<PostProcessingComponentBase>();
        List<PostProcessingComponentBase> m_ComponentsToDisable =
            new List<PostProcessingComponentBase>();
        ...
        void CheckObservers()
        {
            foreach (var cs in m_ComponentStates)
            {
                ...
                {
                    if (state)
                        m_ComponentsToEnable.Add(component);
                    else
                        m_ComponentsToDisable.Add(component);
                }
            }
        ...
        bool TryPrepareUberImageEffect<T>(
