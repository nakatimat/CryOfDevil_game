...
namespace UnityEditor.PostProcessing
{
    ...
    public class PostProcessingInspector : Editor
    {
        ...
        void OnEnable()
        {
            ...
            {
                var attr = (PostProcessingModelEditorAttribute)
                    editor.GetCustomAttributes(typeof(PostProcessingModelEditorAttribute), false)[
                        0
                    ];
            ...
            while (property.Next(true))
            {
                ...
                var type = baseType;
                var srcObject = ReflectionUtils.GetFieldValueFromPath(
        ...
        public override void OnPreviewSettings()
        {
            using (new EditorGUILayout.HorizontalScope())
            {
                ...
                GUILayout.Space(5);
                m_CurrentMonitorID = EditorGUILayout.Popup(
                    m_CurrentMonitorID,
                    m_MonitorNames,
                    FxStyles.preDropdown,
